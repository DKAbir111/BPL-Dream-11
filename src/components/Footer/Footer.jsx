...
export default function Footer() {
    return (
        ...
        <div className="bg-[#07091a] flex flex-col p-10 items-center gap-10 relative mt-40">
            ...
            <div className="absolute -top-32 w-5/6 border rounded-lg bg-white p-5 backdrop-blur-lg bg-opacity-95"  >
                <div className="flex flex-col gap-5 justify-center items-center p-10 rounded-lg" style={{ backgroundImage: `url(${Backgound})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className="flex flex-col items-center mt-32 gap-10">
                ...
                <footer className="grid grid-cols-3 text-base-content container md:mx-auto w-full gap-40">
